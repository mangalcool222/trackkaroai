...
export const HRDashboard = ({ navigation }: any) => {
    ...
    const QuickAction = ({ icon: Icon, label, onPress, visible }: any) => {
        ...
        return (
            <TouchableOpacity style={styles.actionButton} onPress={onPress}>
                <View style={[styles.iconCircle, { backgroundColor: '#ffe6eb' }]}>
                    <Icon size={24} color="#FF2D55" />
                </View>
            ...
            <ScrollView contentContainerStyle={styles.content}>
                ...
                <View style={styles.header}>
                    <View>
                        ...
                        <Text style={styles.businessName}>My Team</Text>
                    </View>
                    <TouchableOpacity style={styles.profileButton}>
                        <Text style={styles.profileInitials}>HR</Text>
                    </TouchableOpacity>
                </View>
